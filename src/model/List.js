  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('links'))
        obj.links = ListLinks.constructFromObject(data['links']);
      if (data.hasOwnProperty('meta'))
        obj.meta = ListMeta.constructFromObject(data['meta']);
    }
    return obj;
  }
}
...
/**
 * @member {module:model/ListLinks} links
 */
List.prototype.links = undefined;

/**
 * @member {module:model/ListMeta} meta
 */
List.prototype.meta = undefined;
